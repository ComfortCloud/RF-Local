...
int main(int argc, char **argv)
{
	...
	pReaderHostName = "115.156.142.223"; //192.168.0.105
	...
	int cnt1 = 0;
	for (auto it1 = myApp.antDataVec1.begin(); it1 != myApp.antDataVec1.end(); it1++)
	{
		cout << (*it1).epc << " " << (*it1).phase << " " <<std::fixed<< myApp.timeVec1[cnt1]<< " "<< (*it1).rssi << endl;
		cnt1++;
	}
